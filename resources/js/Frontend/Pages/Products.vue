                      ...
                      <div class="product-item">
                        <div class="inner-content">
                          <div class="product-thumb">
                            ...
                            <span v-if="product.sale" class="sale-title sticker"
                              >Sale</span
                            >
                            <span
                              v-if="product.remise"
                              class="percent-count sticker"
                              >-{{ product.remise.pourcentage }}%</span
                            >
                            <div class="product-action">
                              <div class="addto-wrap">
                                ...
                                <a class="add-quick-view" href="#" @click="FillProduct(product)">
                      ...
                      <div class="pagination-content-wrap border-top">
                        <nav class="pagination-nav">
                          <ul class="pagination justify-content-center">
                            <li>
                              <a class="disabled active prev" href="shop.html"
                                >Prev</a
                              >
                            </li>
                            <li>
                              <a class="disabled active" href="shop.html">1</a>
                            </li>
...
<script>
import { InitQuickView } from '../../VanilaJs/quickview'
export default {
  data() {
    return {
      products: [],
  ...
  methods: {
    async getProducts() {
      return await axios.get("/api/products").then((response) => {
